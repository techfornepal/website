...
export const Prose: React.FC<ProseProps> = ({ children, className }) => {
  return (
    <div className={cn(
      ...
      'prose-p:text-[color:var(--text-primary)] prose-p:leading-relaxed',
      ...
      'prose-code:text-[color:var(--primary)] prose-code:bg-[color:var(--surface)] prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:font-medium',
      ...
      'prose-li:text-[color:var(--text-primary)]',
