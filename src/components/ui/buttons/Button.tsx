...
const baseClasses = 'inline-flex items-center justify-center font-[var(--font-weight-semibold)] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--focus-ring)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed';
...
const variantClasses = {
  ...
  'subtle-primary': 'bg-[color:var(--primary)]/90 backdrop-blur-sm hover:bg-[color:var(--secondary)]/90 text-white font-[var(--font-weight-medium)] rounded-xl border border-[color:var(--primary)]/20 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02]',
  ...
  success: 'bg-gradient-to-r from-[color:var(--success)] to-[color:var(--success-hover)] text-white hover:from-[color:var(--success-hover)] hover:to-[color:var(--success-dark)] shadow-lg hover:shadow-xl border border-[color:var(--success)]',
  warning: 'bg-gradient-to-r from-[color:var(--warning)] to-[color:var(--warning-hover)] text-white hover:from-[color:var(--warning-hover)] hover:to-[color:var(--warning-dark)] shadow-lg hover:shadow-xl border border-[color:var(--warning)]',
  error: 'bg-gradient-to-r from-[color:var(--error)] to-[color:var(--error-hover)] text-white hover:from-[color:var(--error-hover)] hover:to-[color:var(--error-dark)] shadow-lg hover:shadow-xl border border-[color:var(--error)]',
