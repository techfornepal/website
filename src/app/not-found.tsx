      ...
      <Container size="md" className="text-center">
        <Stack spacing="3xl" align="center">
          <Stack spacing="xl" align="center">
            <div className="font-title text-8xl leading-none font-bold text-[color:var(--text-muted)]/30 select-none">
              404
            </div>
          ...
          <NavigationLink href="/" icon={<ArrowLeft size={16} />} iconPosition="left">
            Go Home
          </NavigationLink>
        </Stack>
      </Container>
